...
### 🎛️ 技術対応
- **従来の要素**: `ytd-video-renderer`, `ytd-rich-item-renderer`, `ytd-compact-video-renderer`
- **新しい要素**: `yt-lockup-view-model` (関連動画用)
...
**関連動画のブロック**:
- 動画再生中に右側の関連動画にも小さな「🚫 ブロック」ボタンが表示
